                            ...
                            <div class="contentarea">
                                ...
                                <div class="row-fluid">
                                    <div class="span_full module_cont module_text_area">
                                        <h4 class="headInModule"><?=$visitas['titulo']?></h4>
                                        <p><?=$visitas['texto']?></p></div>								
                                </div><!-- .row-fluid -->
                                <div class="row-fluid">
                                  <div class="row-fluid">
                                    <div class="span12 module_cont module_accordion">
                                      ...
                                      <div class="shortcode_accordion_shortcode accordion">
                                        <h5 class="shortcode_accordion_item_title expanded_yes" data-count="1"> <?=$concepto['titulo']?><span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"> <?=$concepto['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="2"> <?=$caracteristicas['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$caracteristicas['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="3"> <?=$registracion['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$registracion['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="4"> <?=$categoria_de_visitante['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$categoria_de_visitante['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="5"> <?=$pre_autorizacion['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$pre_autorizacion['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="6"> <?=$ingreso['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$ingreso['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="7"> <?=$objetos['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$objetos['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="8"> <?=$reportes['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$reportes['texto']?></div>
                                        </div>
                                      </div>
                                      <!--.accordion-->
                                    </div>
