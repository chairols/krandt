                            ...
                            <div class="contentarea">
                                ...
                                <div class="row-fluid">
                                    <div class="span_full module_cont module_text_area">
                                        <h4 class="headInModule"><?=$control_de_accesos['titulo']?></h4>
                                        <p><?=$control_de_accesos['texto']?></p></div>								
                                </div><!-- .row-fluid -->
                                <div class="row-fluid">
                                  <div class="row-fluid">
                                    <div class="span12 module_cont module_accordion">
                                      ...
                                      <div class="shortcode_accordion_shortcode accordion">
                                        <h5 class="shortcode_accordion_item_title expanded_yes" data-count="1"> <?=$acceso_peatonal['titulo']?><span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"> <?=$acceso_peatonal['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="2"> <?=$estacionamiento['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$estacionamiento['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="3"> <?=$acceso_vehicular['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$acceso_vehicular['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="4"> <?=$base_de_datos['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$base_de_datos['texto']?></div>
                                        </div>
                                      </div>
                                      <!--.accordion-->
                                    </div>
