        ...
        <div class="header_wrapper container">
            ...
            <nav>
                <ul class="menu">
                    ...
                    <li class="current-menu-parent"><a href="/clientes/">Clientes</a></li>               
                	...
                	<div class="row">
                        <div class="posts-block span12">
                          <div class="contentarea">
                                ...
                                </div><!-- .row-fluid --><!-- .row-fluid --><!-- .row-fluid --><!-- .row-fluid -->

                                <div class="row-fluid">
                                    <div class="span12 module_cont module_feature_posts">
                                        <h4 class="headInModule">&nbsp;</h4>
                                        <div class="featured_slider">
                                          <div class="module_content sponsors_works carouselslider items5" data-count="5">
                                            <ul>
                                              <li>
                                                 <img src="/assets/sitio/img/pictures/partner1.jpg" width="200" height="60"> 
                                              </li>
                                              <li>
                                                  <img src="/assets/sitio/img/pictures/partner2.jpg" width="200" height="60"> 
                                              </li>
                                              <li>
                                               <img src="/assets/sitio/img/pictures/partner3.jpg" width="200" height="60">
                                              </li>
                                              <li>
                                                 <img src="/assets/sitio/img/pictures/partner4.jpg" width="200" height="60"> 
                                              </li>
                                              <li>
                                                 <img src="/assets/sitio/img/pictures/partner5.jpg" width="200" height="60">
                                              </li>   
