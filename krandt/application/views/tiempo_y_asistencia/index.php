                            ...
                            <div class="contentarea">
                                ...
                                <div class="row-fluid">
                                    <div class="span_full module_cont module_text_area">
                                        <h4 class="headInModule"><?=$tiempo_y_asistencia['titulo']?></h4>
                                        <p><?=$tiempo_y_asistencia['texto']?></p></div>								
                                </div><!-- .row-fluid -->
                                <div class="row-fluid">
                                  <div class="row-fluid">
                                    <div class="span12 module_cont module_accordion">
                                      ...
                                      <div class="shortcode_accordion_shortcode accordion">
                                        <h5 class="shortcode_accordion_item_title expanded_yes" data-count="1"> <?=$admin_descentralizada['titulo']?><span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"> <?=$admin_descentralizada['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="2"> <?=$usuarios_administradores['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$usuarios_administradores['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="3"> <?=$recepcion_de_fichadas['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$recepcion_de_fichadas['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="4"> <?=$turnos_y_rotaciones['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$turnos_y_rotaciones['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="5"> <?=$procesamiento_de_fichadas['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$procesamiento_de_fichadas['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="6"> <?=$horas_extras['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$horas_extras['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="7"> <?=$calculo_de_horas['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$calculo_de_horas['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="8"> <?=$administracion_de_novedades['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$administracion_de_novedades['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="9"> <?=$liquidacion_de_sueldos['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
                                          <div class="ip"><?=$liquidacion_de_sueldos['texto']?></div>
                                        </div>
                                        <h5 class="shortcode_accordion_item_title" data-count="10"> <?=$otras_caracteristicas['titulo']?> <span class="ico"></span> </h5>
                                        <div class="shortcode_accordion_item_body">
